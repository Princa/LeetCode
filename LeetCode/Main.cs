...
namespace LeetCode
{
	class Program
	{
		static void Main (string[] args)
		{
			...
			newsll.Add (21);
			newsll.Add (50);
			LinkedList.SinglyLinkedList s2 = new LinkedList.SinglyLinkedList ();
			s2.Add (2);
			s2.Add (7);
			s2.Add (8);
			s2.Add (15);
			...
			//newsll.root = newsll.PairwiseSwapRecursive(newsll.root);

			//newsll.ListAll();
			//newsll.PrintReverseRecursive(newsll.root);

//			LinkedList.SinglyLinkedList sortedIntersection = new LinkedList.SinglyLinkedList ();
//			sortedIntersection.root = newsll.SortedIntersectionTwoLinkedList (newsll.Head, s2.Head);
//			sortedIntersection.ListAll ();

			//newsll.DeleteAltRecursive(newsll.root);

//			SinglyLinkedList sortMergedList = new SinglyLinkedList ();
//			sortMergedList.root = sortMergedList.SortedMergeRecursive (newsll.Head, s2.Head);
//			sortMergedList.ListAll ();

			s3.ListAll ();
			s3.root = MergeSortSinglyLinkedList.MergeSort (s3.Head);
			s3.ListAll ();
